...
public class TestRedis {
	...
	public void testString() {
		// 添加数据
		jedis.set("name", "sunlight001"); // key为name放入value值为sunlight001
		...
		// s设置多个键值对
		jedis.mset("name", "sunlight001", "age", "20", "email", "sunlight001@qq.com");
    ...
    public void testSet(){
        ...
        jedis.sadd("user","sunlight001");
        jedis.sadd("user","are");
        //移除user集合中的元素are
        jedis.srem("user","are");
        System.out.println("user中的value:"+jedis.smembers("user"));//获取所有加入user的value
        System.out.println("sunlight001是否是user中的元素:"+jedis.sismember("user","sunlight001"));//判断sunlight001是否是user集合中的元素
